...
interface UnlockPodcastsModalProps extends DialogOptions {
    ids: number[];
}

export default function UnlockPodcastsModal({
    ids,
    onClose,
}: UnlockPodcastsModalProps) {
    ...
    return (
        <Box m={4}>
            ...
            >
                Unlock selected podcast(s)?
            </Typography>

            <Column mb={4}>
                <Typography variant='subtitle1'>
                    Are you sure you want to unlock selected podcast(s)?
                </Typography>
            </Column>
