...
interface UnlockGamesModalProps extends DialogOptions {
    ids: number[];
}

export default function UnlockGamesModal({
    ids,
    onClose,
}: UnlockGamesModalProps) {
    ...
    return (
        <Box m={4}>
            ...
            >
                Unlock selected game(s)?
            </Typography>

            <Column mb={4}>
                <Typography variant='subtitle1'>
                    Are you sure you want to unlock selected game(s)?
                </Typography>
            </Column>
