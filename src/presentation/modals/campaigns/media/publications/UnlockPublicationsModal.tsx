...
interface UnlockPublicationsModalProps extends DialogOptions {
    ids: number[];
}

export default function UnlockPublicationsModal({
    ids,
    onClose,
}: UnlockPublicationsModalProps) {
    ...
    return (
        <Box m={4}>
            ...
            >
                Unlock selected publication(s)?
            </Typography>

            <Column mb={4}>
                <Typography variant='subtitle1'>
                    Are you sure you want to unlock selected publication(s)?
                </Typography>
            </Column>
