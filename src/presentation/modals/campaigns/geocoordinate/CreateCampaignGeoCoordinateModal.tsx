...
import CreateCampaignGeoCoordinateUseCase
    from 'application/usecases/campaigns/geoCoordinate/CreateCampaignGeoCoordinateUseCase';
...
export default function CreateCampaignGeoCoordinateModal({
    campaignId,
    onClose,
}: CreateCampaignIpAddressModalProps): ReactElement {
    const createCampaignGeoCoordinateUseCase = Container.resolve(CreateCampaignGeoCoordinateUseCase);
    ...
    const {
        ...
        handleSubmit,
        setValues,
    } = useForm<CampaignGeoCoordinateModel>({ defaultValues: { campaignId } });
    ...
    async function onSubmit(values: CampaignGeoCoordinateModel): Promise<boolean> {
        const result = await createCampaignGeoCoordinateUseCase.handle(values);
