...
interface AdvertsDeleteModalProps extends DialogOptions {
    ids: number[];
}

export default function DeleteAdvertsModal({
    ids,
    onClose,
}: AdvertsDeleteModalProps) {
    ...
    async function onSubmit(): Promise<boolean> {
        const deletionPromises = ids.map((id) => removeAdvertUseCase.handle(id));
