...
export default function PlatformTopbarDropdown({ open }: { open: boolean }) {
    ...
    return (
        <EditorSidebarDropdown label='Topbar' open={open}>
            <ColorSelect
                control={control}
                defaultColor={editorColorsPalette.header.background}
                label='Background'
                name='headerBackgroundColor'
                onBlur={(e) => setInteraction({ name: 'headerBackgroundColor', value: e.target.value })}
            />
            <ColorSelect
                control={control}
                ...
                onBlur={(e) => setInteraction({ name: 'headerFontColor', value: e.target.value })}
            />
